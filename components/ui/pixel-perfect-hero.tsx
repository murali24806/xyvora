          ...
          <div className="relative w-full overflow-hidden [mask-image:linear-gradient(to_right,transparent,white_15%,white_85%,transparent)]">
            <div className="flex w-max gap-12 py-1 animate-marquee">
              <div className="flex gap-12 items-center">
                {stats 
                  ? stats.map((stat, i) => (
                      <div key={i} className="flex flex-col items-center justify-center opacity-80">
                        <span className="text-2xl font-bold text-white mb-0.5">{stat.value}</span>
              ...
              <div className="flex gap-12 items-center" aria-hidden="true">
                {stats 
                  ? stats.map((stat, i) => (
                      <div key={`c-${i}`} className="flex flex-col items-center justify-center opacity-80">
                        <span className="text-2xl font-bold text-white mb-0.5">{stat.value}</span>
                        <span className="text-[10px] uppercase text-gray-400">{stat.label}</span>
                      </div>
                    ))
        ...
        <div className="relative w-full max-w-5xl overflow-hidden [mask-image:linear-gradient(to_right,transparent,white_15%,white_85%,transparent)]">
          <div className="flex w-max gap-16 py-3 animate-marquee">
            ...
            <div className="flex gap-16 items-center" aria-hidden="true">
              {stats 
                ? stats.map((stat, i) => (
                    <div key={`c-${i}`} className="flex flex-col items-center justify-center opacity-80 hover:opacity-100 transition-opacity">
                      <span className="text-3xl font-bold text-white mb-1">{stat.value}</span>
                      <span className="text-xs uppercase tracking-wider text-gray-400">{stat.label}</span>
                    </div>
                  ))
